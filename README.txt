...
plugins. And please execute the following command with administrator privilege to make
sure that python.exe of Python 2.7 will be executed from FileInsight.
